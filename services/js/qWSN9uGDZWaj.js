...
!(function (t, n) {
  ...
  function g(t) {
    for (var n = new Array(t.length), r = 0; r < t.length; r++)
      "object" == typeof t[r] &&
        (n[r] = new RegExp("^(?:" + t[r].pattern + ")$"));
    return function (r, e) {
      for (
        var i = "", o = (e && e.encode) || encodeURIComponent, u = 0;
        u < t.length;
        u++
      ) {
        var f = t[u];
  ...
  var R = {
    ...
    T = new ((function () {
      ...
      return (
        (e.init = function (t, n) {
          ...
          (this.h.push(r),
            window.history && window.history.replaceState(r, "", r.url));
        }),
        (e.add = function (t, n, r) {
          var e = r ? r.state : null,
            i = e ? e.ns : "tmp",
            o = e ? e.index : this.size,
            u = "none";
          "popstate" !== n && (u = this.v(n));
          var f = {
            index: o,
            ns: i,
            scroll: { x: window.scrollX, y: window.scrollY },
          ...
          switch ((this.h.push(f), u)) {
            case "push":
              window.history && window.history.pushState(f, "", f.url);
              break;
            case "replace":
              window.history && window.history.replaceState(f, "", f.url);
          }
        }),
        (e.remove = function () {
          this.h.pop();
        ...
        (e.update = function (t) {
          ...
          ((this.current = n),
            window.history && window.history.replaceState(n, "", n.url));
        }),
        (e.cancel = function () {
        ...
        (e.getDirection = function (t) {
          var n = "popstate";
          return (
            t < this.current.index
              ? (n = "back")
              : t > this.current.index && (n = "forward"),
            n
          );
        }),
        (e.v = function (t) {
        ...
        var r = (function () {
          if (!n.next.html)
            return Promise.resolve(t).then(function (t) {
              ...
              if (t) {
                var e = O.toElement(t);
                ((r.namespace = O.getNamespace(e)),
                  (r.container = O.getContainer(e)),
                  (r.html = t),
                  T.update({ ns: r.namespace }));
    ...
    q = function (t) {
      ...
      var s = o.indexOf("?");
      return (
        s >= 0 && ((u = B(o.slice(s + 1))), (o = o.slice(0, s))),
  ...
  var N = new ((function (t) {
    ...
    X = (function (t) {
      ...
      return (
        (i.set = function (t, n, r) {
          return (
            this.checkHref(t) || this.h.set(t, { action: r, request: n }),
            { action: r, request: n }
          );
        }),
        (i.get = function (t) {
    ...
    Y = function (t) {
      return Boolean(
        t.el.closest("[" + R.prefix + "-" + R.prevent + '="all"]'),
      );
    },
    Z = function (t) {
      var n = t.href;
    ...
    rt = (function () {
      ...
      return (
        (n.add = function (t, n) {
          switch (t) {
            case "rule":
              this.p.splice(n.position || 0, 0, n.value);
              break;
            case "transition":
            default:
              this.all.push(n);
        ...
        (n.resolve = function (t, n) {
          ...
          var i = new Map(),
            o = e.find(function (e) {
              ...
              return (
                !(!n.self || "self" !== e.name) ||
                (r.p.reverse().forEach(function (n) {
                  o &&
                    ((o = r.P(e, n, t, u)),
                    e.from &&
                      e.to &&
                      (o = r.P(e, n, t, u, "from") && r.P(e, n, t, u, "to")),
                    e.from && !e.to && (o = r.P(e, n, t, u, "from")),
                    !e.from && e.to && (o = r.P(e, n, t, u, "to")));
                }),
                i.set(e, u),
                o)
              );
          ...
          if (i ? v && v[s] : v[s]) {
            switch (n.type) {
              ...
              default:
                ...
                break;
              case "object":
                var w = Array.isArray(v[a]) ? v[a] : [v[a]];
                l[a] &&
                  (l[a].name && -1 !== w.indexOf(l[a].name) && (u = !0),
                  -1 === w.indexOf(l[a].name) && (o = !1));
                break;
              case "function":
                v[h](r) ? (u = !0) : (o = !1);
            }
      ...
      return (
        ...
        (r.doOnce = function (t) {
          ...
          try {
            ...
            var u = s(
              function () {
                return Promise.resolve(i.R("beforeOnce", n, o)).then(
                  function () {
                    return Promise.resolve(i.once(n, o)).then(function () {
                      return Promise.resolve(i.R("afterOnce", n, o)).then(
                        function () {},
                      );
                    });
                  },
        ...
        (r.doPage = function (t) {
          ...
          try {
            ...
            var h = s(
              function () {
                function t() {
                  return Promise.resolve(f.R("before", n, c)).then(function () {
                    var t = !1;
                    function r(r) {
                      return t
                        ? r
                        : Promise.resolve(f.remove(n)).then(function () {
                            return Promise.resolve(f.R("after", n, c)).then(
                              function () {},
                            );
                          });
                    }
                        ...
                        u = s(
                          function () {
                            return Promise.resolve(
                              ...
                              return Promise.resolve(
                                Promise.all([f.leave(n, c), S(e, n)]).then(
                                  function (t) {
                                    return t[0];
                                  },
                                ),
                                ...
                                return (
                                  (o = t),
                                  Promise.resolve(f.R("afterLeave", n, c)).then(
                                    function () {},
                                  )
                                );
                              });
              ...
              function (t) {
                if (((f.A = !1), t.name && "BarbaError" === t.name))
        ...
        (r.add = function (t, n) {
          try {
            return (
              O.addContainer(t.next.container, n),
              N.do("nextAdded", t),
              Promise.resolve()
            );
          } catch (t) {
  ...
  var ot = {
    ...
    html: void 0,
    namespace: void 0,
    url: { hash: void 0, href: void 0, path: void 0, port: void 0, query: {} },
  };
  return new ((function () {
    function t() {
      ((this.version = a),
    ...
    return (
      ...
      (e.go = function (t, n, r) {
        ...
        if ((void 0 === n && (n = "barba"), this.transitions.isRunning))
          ...
          if ((this.history.add(t, n, r), "popstate" === n && r)) {
            var i = r.state;
            null !== i && (n = this.history.getDirection(i.index));
          }
          return (
          ...
          var u = o.cache.has(t)
            ...
            f = (function () {
              if (o.transitions.shouldWait)
                return Promise.resolve(S(u, o.data)).then(function () {});
            })();
      ...
      (e.q = function () {
        (!0 !== this.prefetchIgnore &&
          (document.addEventListener("mouseover", this.M),
          document.addEventListener("touchstart", this.M)),
          document.addEventListener("click", this.L),
          window.addEventListener("popstate", this.$));
      }),
      (e.B = function () {
        (!0 !== this.prefetchIgnore &&
          (document.removeEventListener("mouseover", this.M),
          document.removeEventListener("touchstart", this.M)),
          document.removeEventListener("click", this.L),
