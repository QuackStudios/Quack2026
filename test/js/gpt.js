...
const reinitWebflowHard = (() => {
  ...
  return () => {
    ...
    const run = () => {
      ...
      try {
        // Destroy existing bindings safely
        try { window.Webflow.destroy(); } catch (_) {}

        // Re-bind base runtime
        window.Webflow.ready();

        // Re-init all commonly used modules
        ...
        // Force layout recalc (important for Lenis + sticky)
